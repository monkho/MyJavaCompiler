...
@members {
  ...
  void pushTSG (String ID, String tipo) {
    ...
    if (existe == null) {
      ...
      textOutput += "ID: " + ID + " already in TSG.\n";
    }
  }
  ...
  void pushTSL (String ID, String tipo) {
    ...
    if (existe == null) {
      ...
      textOutput += "ID: " + ID + " already in TSL.\n";
    }
  }
  ...
  int checkTypes(int t1, int t2) {
    if(t1!=t2) {
      ...
      textOutput += "Error! mismatch types\n";
      return 11;
    }
    return t2;
  }
  ...
  public void displayRecoginitionError(String[] tokenNames, RecognitionException e) {
    ...
    output.appendText("Found error!!: : " + hdr + " " + msg + "\n");
  }
  
  public void setOutput (TextArea _output) {
    this.output = _output;
  }
